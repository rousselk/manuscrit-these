...
%%% REMERCIEMENTS
\include{these-KR-remerciements}
...
\include{these-KR-ch1-intro}

%%% CHAPITRE 2 : CONTEXTE ET PROBLÉMATIQUE
\include{these-KR-ch2-ctx-prob}

%%% CHAPITRE 3 : ÉTAT DE L'ART
\include{these-KR-ch3-etat-art}

%%% CHAPITRE 4 : PLATES-FORMES LOGICIELLES : ÉVALUATION ET AMÉLIORATIONS
\include{these-KR-ch4-pf-logicielles}

%%% CHAPITRE 5 : ÉVALUATION ET COMPARAISON DE PROTOCOLES MAC / RDC
\include{these-KR-ch5-protocoles-mac-rdc}

%%% CHAPITRE 6 : VALIDATION
\include{these-KR-ch6-validation}

%%% CHAPITRE 7 : CONCLUSION ET PERSPECTIVES
\include{these-KR-ch7-concl-persp}


\appendix

%%% PUBLICATIONS ET RÉALISATIONS
\include{these-KR-pub-real}
